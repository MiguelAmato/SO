 ...
 * 
 * 1. El valor de xc no se modifica porque al admitirse solamente el paso de parámetros por valor se deshace el cambio al salir de la función.
 * 	  El cambio sucede en la pila, pero luego se deshace.
 * 2. Hay un error de compilación porque se usa una funcion que no está definida anteriormente. 
 *******************/
