 ...
 * 
 * 	1. 508 bytes de ememoria se reservan
 * 	2. Primera:  0x55f06fc442a0. Ultima :  0x55f06fc442a0 + 508 bytes
 * 	3. Porque se cambia el valor en ptr[0] = 7;
 *  4. Porque ptr2 apunta a la misma direccion de memoria que ptr 
 * 	5. ptr[100] = 13 y ptr2[100] = 13
 * 	6. El error se manifiesta en ejecución, al liberar la memoria del ptr, se deberia volver a usar la funcion malloc para volver a usar el puntero ptr
 *  ***********/
int nelem;
